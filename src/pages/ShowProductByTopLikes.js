...
function ShowProductByTopLikes() {
    ...
    async function OnSubmit() {
        ...
        // console.log(OfferId);
        await fetch(`https://localhost:5001/api/Offer/GetOfferByTopThreeLikes/${Category}`)
  ...
  return (
    ...
    <div>
        <h4 align="center">Offer by Top likes</h4>
        <Form className='px-5'>
            <Col>
                <FormGroup row>
...
export default ShowProductByTopLikes