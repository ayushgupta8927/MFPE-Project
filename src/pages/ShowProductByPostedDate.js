...
function ShowProductByPostedDate() {
    ...
    async function OnSubmit() {
        ...
        const PostedDate = postedDate.current.value;

        // const EmployeeId = employeeId.current.value;
        // console.log(OfferId);
        await fetch(`https://localhost:5001/api/Offer/GetOfferByOpenedDate/${PostedDate}`)
  ...
  return (
    ...
    <div>
        <h4 align="center">Offer by Date</h4>
        <Form className='px-5'>
            <Col>
                <FormGroup row>
                    <label htmlFor="PostedDate">Posted Date</label>
                    <Col sm={10}>
                        <input type="text" name="PostedDate" ref={postedDate} placeholder="Posted Date" />
...
export default ShowProductByPostedDate